...
The active mapping is deliberately narrow. It resolves FireRed Pallet Town’s verified secondary metatile `38`, top-left 8×8 cell, and writes it only to existing Red `OVERWORLD` target tile `82`—the approved grass reuse slot. It does not perform a whole-map, Pallet Town, building, tree, water, door, or animation conversion.
...
Install this mod on **Gen1Recomp 0.2.24 or newer** for **Pokémon Red**. In the launcher’s standard Imported Files flow, select your own supported FireRed English v1.0 source file when the mod requests it. The importer accepts only the expected 16 MiB revision and MD5 `e26ee0d44e809351c8ce2d73c7400cdd`.
...
See the [source repository](https://github.com/inmento/FireRed-Tilesheet-Importer) and the [0.1.0-prototype.2 release](https://github.com/inmento/FireRed-Tilesheet-Importer/releases/tag/v0.1.0-prototype.2).
