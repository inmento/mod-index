...
Current releases use the package and manifest ID **`shedninja`**. Retired releases used `gen1_shedinja`; remove that old package and install Shedinja 0.2.2 once so future launcher updates follow the current identity.
